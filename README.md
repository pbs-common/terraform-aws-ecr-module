...
| <a name="input_environment_images_retention"></a> [environment\_images\_retention](#input\_environment\_images\_retention) | (optional) Number of images to retain based on environment. If set, takes precedence over images_to_retain. | `string` | `"prod"` | no |
