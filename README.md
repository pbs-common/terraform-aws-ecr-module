...
```hcl
github.com/pbs/terraform-aws-ecr-module?ref=0.3.29
```
...
```hcl
module "ecr" {
  source = "github.com/pbs/terraform-aws-ecr-module?ref=0.3.29"
...
| <a name="input_environment_images_retention"></a> [environment\_images\_retention](#input\_environment\_images\_retention) | (optional) Number of images to retain based on environment. If set, takes precedence over images\_to\_retain. | `string` | `"prod"` | no |
